const experiences = [
    {
        ...
        company: "Ayahtek",
        description: "Full Stack Developer specializing in building dynamic and user-friendly websites, with experience in both frontend and backend technologies to deliver complete, efficient, and scalable web solutions.",
        technologies: ["Vue", "TypeScript", "JavaScript", "PhP Laravel", "MySQL", "Postman", "SourceTree", "GitHub"],
        current: true
    }
]
...
export const Experience = () => {
    return <section id="experience" className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-3xl mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-300 text-secondary-foreground">Experience that
                <span className="font-serif italic font-normal text-white"> speaks volumes.
                    ...
                    <p className="text-muted-foreground animate-fade-in animation-delay-500">
                        A timeline of my experience as a beginner in web development
                        </p>
        </div>
        {/* Timeline */}
